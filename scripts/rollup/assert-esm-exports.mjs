 ...
 */
import * as exported from '@seung-ju/openapi-generator';
 ...
 *  node -e "import('@seung-ju/openapi-generator').then((mod) => console.log(JSON.stringify(Object.keys(mod), null, 2)))" > scripts/rollup/all-exports.json
 */
